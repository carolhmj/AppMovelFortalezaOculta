...
public class DownloadTexturaPNG2 extends AsyncTask<Void, Void, File> {
    ...
    public File downloadTexturaSincrono() throws IOException {
        ...
        Log.i(Constantes.TAG, "Baixando textura:" + arquivo + " em " + Armazenamento.resgatarIPArquivos(LoginActivity.getInstance()) + "objeto3d/" + arquivo);
        URL url = new URL(Armazenamento.resgatarIPArquivos(LoginActivity.getInstance()) + "objeto3d/" + arquivo);
